  ...
  return (
    ...
    >
      <div className="mx-auto w-[90%] md:w-[92%] max-w-[1040px]">
        ...
        {/* Asymmetric Grid: Form (3fr) + Contact Cards (2fr) */}
        <section className="grid grid-cols-1 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] gap-8 items-start">
            ...
            <div className="px-6 py-6">
              ...
              {showMessage && (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: submitStatus === 'success' ? 'rgba(5, 150, 105, 0.05)' : 'rgba(239, 68, 68, 0.05)'
                  }}
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full rounded-full py-3 font-semibold text-sm transition-all duration-200 disabled:opacity-50 hover:shadow-md"
                  style={{
            ...
            >
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="flex items-start gap-3">
                  ...
                  >
                    <svg className="w-4 h-4" style={{ color: 'var(--accent-color)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-xs font-medium mb-0.5" style={{ color: 'var(--text-color)' }}>
                ...
                {faqs.map((faq, index) => (
                  <div key={index} className="group">
                    <button
                      ...
                      className="flex cursor-pointer items-center justify-between w-full px-3 py-3 text-left"
                    >
                      <span
                        className="text-xs font-medium pr-3"
                        style={{ color: 'var(--text-color)' }}
                      >
                        {faq.question}
                      </span>
                    ...
                    <div
                      className={`overflow-hidden transition-all duration-200 ${openFaq === index ? 'max-h-40 pb-3 px-3' : 'max-h-0'}`}
                    >
                      <p
                        className="text-xs"
                        style={{ color: 'var(--text-secondary)' }}
